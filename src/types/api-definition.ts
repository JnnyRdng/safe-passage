import { DefinitionKeys, InferSearchParams, Params, ParamType } from "./route-definition";
...
export type RouterAPI<
  ...
  ? X extends Params ? X : undefined
  : undefined
> = PublicMethods<S> & {
  [K in keyof T as K extends DefinitionKeys ? never : K]:
  T[K] extends { __argType: infer A }
  ? (value?: A extends keyof TypeMap ? TypeMap[A] : never) => RouterAPI<Clean<T[K]>>
  : RouterAPI<
    Clean<T[K]>,
